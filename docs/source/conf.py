...
latex_documents = [
    (master_doc, 'strucscan.tex', u'StrucScan Documentation',
     u'Isabel Pietka, Yury Lysogorskiy, Ralf Drautz, Thomas Hammerschmidt', 'manual'),
]
...
man_pages = [
    (master_doc, 'strucscan', u'StrucScan Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'strucscan', u'StrucScan Documentation',
     author, 'strucscan', 'One line description of project.',
     'Miscellaneous'),
]
